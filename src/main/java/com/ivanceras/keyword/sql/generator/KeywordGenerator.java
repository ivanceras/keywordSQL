...
import com.ivanceras.keyword.sql.BaseSQL;
...
public class KeywordGenerator {
	...
	String dir = "./gen/src/com/ivanceras/keyword/sql/";
	String packageName = "com.ivanceras.keyword.sql";
	...
	void generateKeywords(){
		...
		sw.lnprint("*");
		sw.lnprint("*/");
		sw.lnprint("public abstract class Keywords extends "+BaseSQL.class.getSimpleName()+"{");
		sw.lnprint();
		sw.lnprint();
		...
		sw.lnprint();
		sw.lnprint("}");
		FileUtil.writeToFile(sw.toString(), dir, "Keywords.java");
	...
	void generateStatics(){
		...
		sw.lnprint();
		sw.lnprint("}");
		FileUtil.writeToFile(sw.toString(), dir, "KeywordsStatics.java");
	}
